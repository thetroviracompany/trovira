      ...
      <div className="bg-gradient-to-r from-purple-700 to-purple-500 text-white text-sm">
        <div className="max-w-7xl mx-auto px-6 py-2 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://youtube.com/@troviracompany?si=pGQGrNAav-u98Bba"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
            >
            ...
            <a
              href="https://www.instagram.com/trovira_company?igsh=ejJ6dHM5ZnY3b2Vk"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-2">
              <FiMail />
              <span className="font-medium">troviracompany@gmail.com</span>
            </div>
          </div>
        </div>
      </div>
